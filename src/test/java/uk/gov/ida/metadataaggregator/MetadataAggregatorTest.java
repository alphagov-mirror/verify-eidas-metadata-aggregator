...
public class MetadataAggregatorTest {
    ...
    private final MetadataStore testS3BucketMetadataStore = mock(MetadataStore.class);
    ...
    public void before() throws MalformedURLException {
        testAggregator = new MetadataAggregator(testMetadataSourceConfiguration, testMetadataSource, new HexEncodedMetadataStore(testS3BucketMetadataStore));
        urlList = new HashMap<>();
    ...
    public void shouldUploadMetadataDownloadedFromSourceToStore()
        ...
        verify(testS3BucketMetadataStore).upload(HexUtils.encodeString(testUrl1.toString()), testMetadata1);
    }
    ...
    public void shouldUploadMultipleMetadataDownloadedFromSourceToStore()
        ...
        verify(testS3BucketMetadataStore).upload(HexUtils.encodeString(testUrl1.toString()), testMetadata1);
        verify(testS3BucketMetadataStore).upload(HexUtils.encodeString(testUrl2.toString()), testMetadata2);
    }
    ...
    public void shouldNotUploadMetadataWhenExceptionThrownByMetadataSource()
        ...
        verify(testS3BucketMetadataStore, never()).upload(anyString(), any(EntityDescriptor.class));
    }
    ...
    public void shouldUploadValidMetadataWhenExceptionThrowByMetadataSource()
        ...
        verify(testS3BucketMetadataStore).upload(HexUtils.encodeString(successfulUrl.toString()), successfulMetadata);
    }
    ...
    public void shouldUploadValidMetadataWhenPreviousUploadFailed()
        ...
        doThrow(new MetadataStoreException("Metadata store failed"))
                .when(testS3BucketMetadataStore).upload(HexUtils.encodeString(unsuccessfulUrl.toString()), unsuccessfulMetadata);
    ...
    public void shouldDeleteMetadataWhenDownloadIsUnsuccessful()
        ...
        verify(testS3BucketMetadataStore).delete(HexUtils.encodeString(unsuccessfulUrl.toString()));
    }
    ...
    public void shouldThrowExceptionWhenDeleteMetadataFails()
        ...
        doThrow(new MetadataStoreException("Delete metadata has failed"))
                .when(testS3BucketMetadataStore).delete(HexUtils.encodeString(unsuccessfulUrl.toString()));
    ...
    public void shouldDeleteMetadataFromS3BucketWhenNotInConfig()
        ...
        when(testMetadataSource.downloadMetadata(testUrl1)).thenReturn(testMetadata1);
        when(testMetadataSource.downloadMetadata(testUrl2)).thenReturn(testMetadata2);
        when(testS3BucketMetadataStore.list()).thenReturn(s3BucketUrls);

        testAggregator.aggregateMetadata();

        verify(testS3BucketMetadataStore).delete(HexUtils.encodeString(testUrl3.toString()));
        verify(testS3BucketMetadataStore).upload(HexUtils.encodeString(testUrl1.toString()), testMetadata1);
        verify(testS3BucketMetadataStore).upload(HexUtils.encodeString(testUrl2.toString()), testMetadata2);
    }
    ...
    public void shouldUploadMetadataWhenRetrievingKeysFromS3BucketFails() throws MetadataSourceException, MetadataStoreException {
        ...
        doThrow(new MetadataStoreException("Unable to retrieve keys from S3 Bucket"))
                .when(testS3BucketMetadataStore).list();
        when(testMetadataSource.downloadMetadata(testUrl1)).thenReturn(testMetadata1);
        when(testMetadataSource.downloadMetadata(testUrl2)).thenReturn(testMetadata2);
